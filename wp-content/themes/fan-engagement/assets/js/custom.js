      ...
      onLeave: function(index, nextIndex, direction) {
        ...
        if(nextIndex.anchor == 01) { // Home
          ...
          if ( $('.book_a_demo').hasClass( "hideDesktop" ) ) {
            ...
            if (matches) {
              var tl = gsap.timeline();
              tl.from("#whatisit h2", { duration: 2, x: 100, delay: .5, opacity: 0, ease: "expo", });
          ...
          if (matches) {
            var tl = gsap.timeline();
            tl.from("#whereitworks h2", { duration: 2, x: 100, delay: .5, opacity: 0, ease: "expo", });
            tl.from("#whereitworks .aStats", { duration: 1, opacity: 0, scale: 1.5, x: -10, stagger: 0.25 }, '<-.5');
          }
          ...
          if (matches) {
            ...
            tl.from("#whysms .aBox", { duration: 1, opacity: 0, scale: 1.5, x: -10, stagger: 0.25 }, '<-.5');
          ...
          if (matches) {
            ...
            mySplitText4 = new SplitText("#bringtheaction1 .movin_text_back", {type:"words,chars"});
          ...
          if (matches) {
            ...
            tl.from("#bringtheaction2 .overlay_img1", { duration: 2, y: -100, opacity: 0, ease: "back", }, "-=3");
            tl.from("#bringtheaction2 .overlay_img2", { duration: 2, y: 100, opacity: 0, ease: "back", }, "-=3");
            mySplitText5 = new SplitText("#bringtheaction2 .movin_text_back", {type:"words,chars"});
          ...
          if (matches) {
            ...
            tl.from("#bringtheaction3 .overlay_img1", { duration: 2, y: -100, opacity: 0, ease: "back", }, "-=3");
            tl.from("#bringtheaction3 .overlay_img2", { duration: 2, y: 100, opacity: 0, ease: "back", }, "-=3");
            mySplitText5 = new SplitText("#bringtheaction3 .movin_text_back", {type:"words,chars"});
            chars5 = mySplitText5.chars;
            tl.from(chars5, {duration: 1, opacity:0, x:-200, rotation:-20,  ease:"back", stagger: 0.1}, "-=6");
          }
          ...
          if (matches) {
            ...
            mySplitText6 = new SplitText("#work .light_bg_text_top", {type:"words,chars"});
            chars6 = mySplitText6.chars;
            tl.from(chars6, {duration: 1, opacity:0, x:-200, rotation:-20,  ease:"back", stagger: 0.1}, "-=4");
            mySplitText7 = new SplitText("#work .light_bg_text_bottom", {type:"words,chars"});
