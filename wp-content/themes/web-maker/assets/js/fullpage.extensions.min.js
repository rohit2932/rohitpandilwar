...
!(function (e, t, n, o, r) {
  ...
  function wo(e, t, n) {
    ...
    (n = void 0 === n ? {} : n),
      "function" == typeof an.CustomEvent
        ...
        : (o = cn.createEvent("CustomEvent")).initCustomEvent(t, !0, !0, n),
      e.dispatchEvent(o);
  }
  function yo(e, t) {
    return (
  ...
  return (
    ...
    function (e, b) {
                ...
                e &&
                  ...
                  Gn(wn + ", " + Cn).forEach(function (e) {
                    ...
                    t &&
                      ...
                      Fn(e, bn) && !Z && e.removeAttribute("data-anchor");
                  }),
                  _t(w),
            ...
            (function () {
              ...
              for (var e = Gn(wn), t = 0; t < e.length; t++) {
                ...
                o.setAttribute("data-fp-styles", o.getAttribute("style")),
                  ...
                  (l = o),
                  (a = n),
                  void 0 !== b.anchors[a] && Fn(l, gn) && kt(b.anchors[a], a),
                  b.menu &&
                    b.css3 &&
      ...
      function le(e, t) {
        "internal" !== t && Qt("fadingEffect") && m.fadingEffect.update(e),
      ...
      function ve() {
        var e = $n(Gn(yn)[0], wn);
        e || (!b.loopBottom && !b.continuousVertical) || (e = Gn(wn)[0]),
          null != e && Ze(e, null, !1);
      }
      function pe(e, t) {
        ...
        if (!Fn(w, vn)) {
          ...
          for (var t = Gn(wn), n = 0; n < t.length; ++n) {
            var o = t[n],
              r = Gn(Rn, o)[0],
              i = Gn(Cn, o);
            b.verticalCentered && Jn(Gn(xn, o), { height: Rt(o) + "px" }),
              Jn(o, { height: Te(o) + "px" }),
      ...
      function Oe(e, t) {
        t || null != Gn(yn)[0] || lo(e, gn),
          ...
          b.paddingBottom && Jn(e, { "padding-bottom": b.paddingBottom }),
      ...
      function He() {
        ...
        if (
          (wo(w, "onScroll"),
          !E && (!b.autoScrolling || b.scrollBar || Qt("dragAndMove")) && !$t())
        ) {
        ...
        if (Be(e)) {
          ...
          ($ = n.y),
            ...
            Gn(Rn, t).length && Math.abs(K - q) > Math.abs(J - $)
              ...
              : b.autoScrolling &&
                x &&
                Math.abs(J - $) > (an.innerHeight / 100) * b.touchSensitivity &&
                ($ < J ? Re("down") : J < $ && Re("up"));
        }
      }
      function Be(e) {
          ...
          if (
            ...
            if (
              ...
              if (
                ...
                (i.direction = l),
                void 0 !== an.fp_dropEffectExtension && m.dropEffect.onLeave(i),
            ...
            Jt("parallax", "apply", i),
              ...
              (Qt("dropEffect") && b.dropEffect) || (lo(e, gn), ao(mo(e), gn)),
              Ke(e),
        ...
        return (
          ...
          e.forEach(function (e) {
            var t = (function () {
                if (cn.domain.length) {
                  for (
                    var e = cn.domain.replace(/^(www\.)/, "").split(".");
                    2 < e.length;
      ...
      function dt(e) {
        ...
        9 === n
          ? (function (e) {
              ...
              l || a) &&
                (s
                  ? null == vo(s, yn + "," + yn + " " + Hn) && (s = f(e))
                  : f(e),
                ((!c && s == u[u.length - 1]) || (c && s == u[0])) && So(e));
            })(e)
          : yo(t, "textarea") ||
            yo(t, "input") ||
            yo(t, "select") ||
      ...
      function wt(e, t, n) {
        ...
        (r.xMovement = Ht(r.prevSlideIndex, r.slideIndex)),
          ...
          !1 === Xe("onSlideLeave", r)
            ? (a = !1)
            : ((Qt("dropEffect") && b.dropEffect) || (lo(t, gn), ao(mo(t), gn)),
      ...
      function Yt(e) {
        ...
        else if (r || i) an.history.replaceState(void 0, void 0, "#" + e);
        else {
